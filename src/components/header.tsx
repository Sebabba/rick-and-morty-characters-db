...
export default function Header({ imageName }: CardProps): JSX.Element {
	...
	if (imageName == 'characters') image = headerCharaters.src;
	else if (imageName == 'locations') image = headerLocations.src;
	else if (imageName == 'episodes') image = headerEpisodes.src;
